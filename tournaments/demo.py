...
if __name__ == "__main__":
    ...
    tournament.add_score(uid=2, orange=3, blue=3, orange_one=Position.DEF, blue_one=Position.DEF)
    tournament.add_score(uid=3, orange=6, blue=4, orange_one=Position.OFF, blue_one=Position.OFF)
    tournament.add_score(uid=4, orange=6, blue=0, orange_one=Position.OFF, blue_one=Position.OFF, joker_blue=1,
                         joker_orange=3)
    ...
    tournament.add_score(uid=8, orange=5, blue=5, orange_one=Position.DEF, blue_one=Position.DEF, joker_orange=11)
    tournament.add_score(uid=9, orange=6, blue=3, orange_one=Position.OFF, blue_one=Position.OFF)
    tournament.add_score(uid=10, orange=6, blue=4, orange_one=Position.OFF, blue_one=Position.OFF)
    # tournament.add_score(uid=11, orange=3, blue=6, orange_one=Position.OFF, blue_one=Position.DEF)
    # tournament.add_score(uid=12, orange=5, blue=6, orange_one=Position.OFF, blue_one=Position.DEF)
    # tournament.add_score(uid=13, orange=1, blue=6, orange_one=Position.DEF, blue_one=Position.OFF)
    # tournament.add_score(uid=14, orange=5, blue=6, orange_one=Position.OFF, blue_one=Position.OFF)
    # tournament.add_score(uid=15, orange=6, blue=5, orange_one=Position.DEF, blue_one=Position.DEF)
    # tournament.add_score(uid=16, orange=1, blue=6, orange_one=Position.OFF, blue_one=Position.DEF)
